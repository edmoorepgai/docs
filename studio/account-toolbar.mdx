...
<img
  src="/images/app/toolbar/toolbar-search-results-framed.png"
  alt="Account toolbar search results"
...
<img
  src="/images/app/toolbar/toolbar-discovery-enrichments-framed.png"
  alt="Account toolbar Discover enrichments"
  className="w-full rounded-xl shadow-sm"
/>
...
<img
  src="/images/app/toolbar/toolbar-file-upload-framed.png"
  alt="Account toolbar file upload"
  className="w-full rounded-xl shadow-sm"
/>
