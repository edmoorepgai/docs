...
<RequestExample>
```bash cURL
curl -X GET "https://api.getpg.ai/v1/workflows" \
...
<RequestExample>
```bash cURL
curl -X POST "https://api.getpg.ai/v1/workflows/trigger" \
  -H "x-api-key: your_api_key" \
...
<RequestExample>
```bash cURL
curl -X GET "https://api.getpg.ai/v1/workflows/executions/{execution_id}" \
  -H "x-api-key: your_api_key"
```
</RequestExample>
