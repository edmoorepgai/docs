...
<RequestExample>
```bash cURL
curl -X GET "https://api.getpg.ai/v1/contacts?page=1&limit=25" \
...
<RequestExample>
```bash cURL
curl -X GET "https://api.getpg.ai/v1/contacts/{contact_id}" \
  -H "x-api-key: your_api_key"
```
</RequestExample>
...
<RequestExample>
```bash cURL
curl -X POST "https://api.getpg.ai/v1/contacts" \
  -H "x-api-key: your_api_key" \
