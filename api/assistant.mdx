...
<RequestExample>
```bash cURL
curl -X POST "https://api.getpg.ai/v1/companies/{company_id}/assistant/chat" \
...
<RequestExample>
```bash cURL
curl -X GET "https://api.getpg.ai/v1/companies/{company_id}/assistant/conversations?page=1&per_page=10" \
  -H "x-api-key: your_api_key"
```
</RequestExample>
...
<RequestExample>
```bash cURL
curl -X GET "https://api.getpg.ai/v1/companies/{company_id}/assistant/conversations/{conversation_id}" \
  -H "x-api-key: your_api_key"
```
</RequestExample>
