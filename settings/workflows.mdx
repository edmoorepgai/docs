...
```mermaid
flowchart TD
    CT[Content Templates] --> CG[Content Groups]
    CI[Custom Insights] --> IG[Insights Groups]
    
    CG --> W[Workflows]
    IG --> W[Workflows]
    ES[Engage Settings] --> W
    P[Personas] --> W
    D[Datasets] --> W
    
    W --> AA[Automated Account Onboarding]
    ...
    subgraph Intelligence ["Intelligence Generation"]
        CI
        IG
    end
    ...
    style W fill:#e1f5fe,stroke:#01579b,stroke-width:3px
    style AA fill:#f3e5f5,stroke:#4a148c,stroke-width:2px
    style Content fill:#e8f5e8,stroke:#2e7d32,stroke-width:2px
