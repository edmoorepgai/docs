...
The **Model Context Protocol** (MCP) is an open standard that lets AI assistants connect to external data sources and tools. Instead of copying and pasting information into your AI tool, MCP lets the AI reach into PG:AI and pull exactly what it needs, when it needs it.
...
PG:AI's MCP server gives your AI assistant access to everything in your account  -  no plugins to install, no code to write.
...
```
Your AI Tool ──── HTTPS ────→ mcp.pipelinegeneration.ai ────→ PG:AI Platform
...
<Card title="Quickstart Guide" icon="rocket" href="/Documentation-New/platform/mcp/quickstart">
