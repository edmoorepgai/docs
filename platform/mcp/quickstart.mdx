...
<Tabs>
  ...
  <Tab title="Cursor">
    ...
    **Option A: Project-level** (recommended for team sharing)
    ...
    ```json
    {
      "mcpServers": {
        "pgai": {
          "url": "https://mcp.pipelinegeneration.ai/mcp",
          "headers": {
  ...
  <Tab title="Windsurf">
    ...
    ```json
    {
      "mcpServers": {
        "pgai": {
          "serverUrl": "https://mcp.pipelinegeneration.ai/mcp",
          "headers": {
            "Authorization": "Bearer pgai_live_YOUR_KEY_HERE"
          }
        }
  ...
  <Tab title="Other MCP Clients">
    ...
    - **Server URL:** `https://mcp.pipelinegeneration.ai/mcp`
    - **SSE URL:** `https://mcp.pipelinegeneration.ai/sse` (for clients that require SSE)
